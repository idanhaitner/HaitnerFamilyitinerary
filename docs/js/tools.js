    ...
    if (!modal) {
      ...
      modal.innerHTML = `
        <div class="modal" role="dialog" aria-modal="true" aria-labelledby="tips-title">
          ...
          <div class="tips-cols">
            <section>
              <h3>כרטיסים ותשלום</h3>
              <ul>
                <li>הוסיפו <strong>Suica / Pasmo</strong> ל־Apple Wallet לפני הנסיעה (או קנו IC בהגעה).</li>
                <li>שינקנסן — כדאי לשריין מושבים מראש בימי נסיעה בין ערים.</li>
                <li>Tax Free: דרכון בקניות מעל ¥5,000 בחנויות משתתפות.</li>
              </ul>
            </section>
            <section>
              <h3>נימוסים וניווט</h3>
              <ul>
                <li>שקט ברכבות — שיחות טלפון לא מקובלות.</li>
                <li>תור מסודר; מושבי עדיפות אמיתיים — הציעו אותם בלב שלם.</li>
                <li>Google / Apple / Yahoo! Maps עובדים מצוין ביפן.</li>
              </ul>
            </section>
          </div>
        </div>`;
