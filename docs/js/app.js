(function () {
  ...
  function mapsLinks(place) {
    const country = place.country || "JP";
  ...
  function syncChrome() {
    ...
    if (els.search) {
      els.search.placeholder = "חיפוש ימים, מקומות…";
    }
    ...
    els.detail.innerHTML = `
      ...
      <div class="detail-layout">
        ...
        <div>
          ...
          <div class="side-block">
            <div class="side-block-head">טיפים</div>
  ...
  const dateShort = (trip.dates || "")
    ...
    .replace("ספטמבר", "ספט׳");
  if (els.brandMeta) {
    els.brandMeta.textContent = `${dateShort || "9–26 ספט׳"} · ${days.length} ימים`;
  }
